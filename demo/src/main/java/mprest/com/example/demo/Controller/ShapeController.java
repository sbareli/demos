...
public class ShapeController {
    ...
    @GetMapping("/{id}")
    public IShape getShapeById(@PathVariable("id") int id) {
    ...
    public void updateTriangle(@PathVariable("id") int id, @RequestBody RightTriangle shape)
    {
        shapeService.updateTriangle(id, shape);
    }
